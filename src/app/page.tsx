...
export default function Home() {
  return (
    <main className="relative bg-cover bg-white md:min-h-screen z-0 max-w-screen-xl mx-auto">
      {/* Background */}
      ...
      <div className="absolute w-full z-20">
        ...
        {/* Services */}
        <div className="md:flex justify-center items-center mx-4 px-4">
          <div className="inline-grid grid-cols-5 items-center justify-center gap-x-20 max-w-none">
            {objects.map((item) => (
              <img key={item.name} src={item.src} alt={item.name} className="col-span-1 object-contain w-[158px] h-[48px] max-h-12 max-w-full" />
            ))}
          </div>
        </div>

        <div className="md:flex bg-transparent justify-center md:mt-16">
          <p className="md:flex md:px-4 md:py-1.5 rounded-3xl text-sm border border-solid border-slate-200 gap-1 hover:border-slate-400">
        ...
        {/* Deploy Advantages */}
        {/* Headings */}
        <div className="mt-[14rem] mx-4 px-4 text-center">
          ...
          <div className="flex justify-center">
            <div className="md:mt-24 md:max-w-[56rem]">
              <div className="md:grid grid-cols-2 grid-rows-2 justify-center gap-x-8 gap-y-16">
                <SvgItems />
              </div>
            </div>
          </div>
        ...
        {/* Hero Banner */}
        <div className="md:mt-56 m-x-auto md:px-4 max-w-[80rem]">
          <div className="relative md:px-20 md:py-24 overflow-hidden rounded-3xl bg-[#111827] ">
            ...
            <div className="relative mx-0 max-w-[42rem]">
              ...
              <figure>
                <blockquote className="text-xl font-semibold text-white leading-8 mt-5">
        ...
        {/* Pricing */}
        <div className="md:px-24 pt-48 mb-20">
          {/* Headings */}
          <div className="mx-auto px-4 max-w-[80rem] text-center">
            ...
            {/* Lists */}
            <div className="grid grid-cols-3 md:mt-20 mx-0 gap-y-8 max-w-none text-left ">
              <div className="flex flex-col md:mt-8 p-10 rounded-3xl rounded-r-none border border-solid border-slate-200 justify-between">
                <div className="">
              ...
              <div className="flex flex-col p-10 rounded-3xl border border-solid-[#e5e7eb] justify-between">
                <div className="">
                  <p className="text-lg font-semibold leading-8">Freelancer</p>
                  <p className="text-sm leading-6 mt-4 text-desc-600 font-light">The essentials to provide your best work for clients.</p>
                  <p className="flex gap-x-1 mt-6 items-baseline">
              ...
              <div className="flex flex-col md:mt-8 p-10 rounded-3xl border border-solid-[#e5e7eb] justify-between">
                <div className="">
